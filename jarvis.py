...
if __name__ == "__main__":
    ...
    if 1:
        ...
        if 'wikipedia' in query:
            ...
            startfile("C:\\Program Files (x86)\\Adobe\\Acrobat Reader DC\\Reader\\AcroRd32.exe")
            ...
            click(x=500, y=843)
            sleep(5)
            print('Adobe Light Room is now open')
            speak('Adobe Light Room is now open')
            ...
            async def main():
                ...
                bulbs = await discovery.discover_lights(broadcast_space="192.168.0.108")
            ...
            webbrowser.open(f"https://wwww.ss{youtube_url}")
            sleep(5)
            click(x=2489, y=745)
            sleep(5)
            click(x=1889, y=1302)
